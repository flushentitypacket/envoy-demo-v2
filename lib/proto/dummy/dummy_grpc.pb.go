...
const (
	DummyService_DoSomething_FullMethodName = "/dummy.DummyService/DoSomething"
)
...
func (c *dummyServiceClient) DoSomething(ctx context.Context, in *DoSomethingRequest, opts ...grpc.CallOption) (*DoSomethingResponse, error) {
	out := new(DoSomethingResponse)
	err := c.cc.Invoke(ctx, DummyService_DoSomething_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDummyServiceServer) DoSomething(context.Context, *DoSomethingRequest) (*DoSomethingResponse, error) {
...
func _DummyService_DoSomething_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DummyServiceServer).DoSomething(ctx, req.(*DoSomethingRequest))
	}
...
var DummyService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "lib/proto/dummy/dummy.proto",
}
